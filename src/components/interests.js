    ...
    >
      <div className="w-100">
        ...
        <p>
          ...
          built up over years of accumulation. I rummage through it at least
          once a week to find the perfect implement for my latest project. It’s
          a mess, but I like it that way. More often than not I’ll get stabbed
          by the pencil I need in my haste to grab the one I was looking for.{" "}
        </p>
        <br />
        <img
        ...
        <p>
          ...
          but honestly it wasn’t as beautiful as the sight of my car at the end
          of the trail. My favorite form of exercise is mountain biking, but
          only the downhill parts. The uphill parts are my least favorite form
          of exercise.
        </p>
        <br />
        <img
        ...
        <p className="mb-0">
          ...
          spectrum. Rational versus irrational. Logic against emotion. But, the
          more I program, the more I come to appreciate that programming is just
          another form of expression. It’s poetry in a sense that’s more
